...
import '../../presentation/web/pages/profile/web_profile_page.dart';
...
import '../../presentation/mobile/pages/loans/lender_loans_list_page.dart';
...
class _RouterNotifier extends ChangeNotifier {
  ...
  String? redirect(BuildContext context, GoRouterState state) {
    ...
    if (session == null && !isPublic) {
      return kIsWeb ? AppConstants.routeWebLogin : AppConstants.routeMobileLogin;
    }
