...
final loansListProvider =
  ...
  var query = Supabase.instance.client.from('loans').select('''
...
class _LoansTable extends StatelessWidget {
                      ...
                      children: [
                        ...
                        if (['pending', 'under_ci'].contains(status))
                          _TableActionBtn(
                            ...
                            onTap: () =>
                                _showApproveModal(context, loan, onRefresh),
                          ),
                        ...
                        if (status == 'pending')
                          Padding(
                            ...
                            child: _TableActionBtn(
                              ...
                              onTap: () =>
                                  _showAssignCIModal(context, loan, onRefresh),
                            ),
                          ),
                      ],
                    ),
  ...
  void _showApproveModal(
      BuildContext context, Map<String, dynamic> loan, VoidCallback onRefresh) {
    showDialog(
      context: context,
      barrierDismissible: false,
  ...
  void _showAssignCIModal(
      BuildContext context, Map<String, dynamic> loan, VoidCallback onRefresh) {
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (_) => AssignCIModal(
          loanId: loan['id'] as String,
          loanCode: loan['loan_code'] as String,
          onSuccess: onRefresh),
    );
  }
}
