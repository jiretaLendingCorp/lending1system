...
final dashboardStatsProvider = FutureProvider<Map<String, dynamic>>((ref) async {
  ...
  return {
    ...
    'pending_collections': collections.where((c) => c['collection_status'] == 'pending').length,
  };
});
...
class _LoanStatusChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final sections = [
      PieChartSectionData(value: 35, color: AppColors.primary500, title: 'Active\n35%',   radius: 80, titleStyle: const TextStyle(fontFamily: 'Poppins', fontSize: 11, fontWeight: FontWeight.w600, color: Colors.white)),
      PieChartSectionData(value: 25, color: AppColors.warning,    title: 'Pending\n25%',  radius: 80, titleStyle: const TextStyle(fontFamily: 'Poppins', fontSize: 11, fontWeight: FontWeight.w600, color: Colors.white)),
      PieChartSectionData(value: 20, color: AppColors.success,    title: 'Done\n20%',     radius: 80, titleStyle: const TextStyle(fontFamily: 'Poppins', fontSize: 11, fontWeight: FontWeight.w600, color: Colors.white)),
      PieChartSectionData(value: 12, color: AppColors.error,      title: 'Overdue\n12%', radius: 80, titleStyle: const TextStyle(fontFamily: 'Poppins', fontSize: 11, fontWeight: FontWeight.w600, color: Colors.white)),
      PieChartSectionData(value: 8,  color: AppColors.accent,     title: 'CI\n8%',        radius: 80, titleStyle: const TextStyle(fontFamily: 'Poppins', fontSize: 11, fontWeight: FontWeight.w600, color: Colors.white)),
    ];
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Loan Status Distribution', style: TextStyle(fontFamily: 'Poppins', fontSize: 16, fontWeight: FontWeight.w700)),
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Recent Activity', style: TextStyle(fontFamily: 'Poppins', fontSize: 16, fontWeight: FontWeight.w700)),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                decoration: BoxDecoration(
                  color: AppColors.successLight,
                ...
                child: const Text('Live', style: TextStyle(fontFamily: 'Poppins', fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.successDark)),
              ),
            ],
          ),
              ...
              if (logs.isEmpty) {
                return const Center(
                  child: Padding(
                    ...
                    child: Text('No recent activity', style: TextStyle(fontFamily: 'Poppins')),
                  ),
                );
              }
              return Column(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(description, style: const TextStyle(fontFamily: 'Poppins', fontSize: 12, fontWeight: FontWeight.w500), maxLines: 1, overflow: TextOverflow.ellipsis),
                              Text(
      ...
      child: const Center(
        child: Column(
          children: [
            ...
            SizedBox(height: 8),
            Text('Failed to load dashboard data', style: TextStyle(fontFamily: 'Poppins')),
          ],
        ),
      ),
    );
